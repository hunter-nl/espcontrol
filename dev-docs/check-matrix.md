...
| `web-smoke` | web, product | Yes | deterministic | — | — | `src/webserver/**`<br>`scripts/check_web_smoke.js`<br>`scripts/check_web_migration_baseline.js`<br>`compatibility/fixtures/web_migration_baseline.json`<br>`scripts/web_source.js`<br>`scripts/web_modules.json` | — | `npm run check:web-smoke` |
