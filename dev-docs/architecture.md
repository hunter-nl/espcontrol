...
| Configuration storage foundation | `components/espcontrol/configuration_store.*` | Atomic two-slot storage for the future versioned device configuration service; not yet the production persistence path. |
