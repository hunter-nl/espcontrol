...
description:
  EspControl on the Guition JC8012P4A1 - a 10.1-inch 1280x800 landscape touchscreen with 15 cards, powered by ESP32-P4.
---

# 10.1-inch JC8012P4A1

The **Guition JC8012P4A1** is a 10.1-inch touchscreen powered by an **ESP32-P4** processor and ESP32-C6 WiFi co-processor. EspControl uses it in landscape orientation, with a 1280x800 layout and room for **15 cards** on the home screen.
